...
void sendDataToNode() {
  float currentVals[5] = { 4.73, 4.62, 4.69, 4.72, 4.81 };
  int randNum = random(5);

  float voltageVals[5] = { 53.16, 54.05, 53.09, 52.88, 52.92 };
  
  int randNum2 = random(5);
  ...
  // String vals = "CM- Current: " + String(abs(chargingCurrent), decimalPrecision) + "A, Voltage: " + String(abs(batteryVoltage), decimalPrecision) + "V, Power: " + String(abs(batteryVoltage * chargingCurrent), decimalPrecision) + "W";
  String vals = "CM- Current: " + String(currentVals[randNum], decimalPrecision) + "A, Voltage: " + String(voltageVals[randNum2], decimalPrecision) + "V, Power: " + String(abs(currentVals[randNum] * voltageVals[randNum2]), decimalPrecision) + "W";
